...
export function AddFilmForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm mt-8">
      ...
      <button 
        type="submit"
        className="w-full text-sm font-bold text-white bg-amber-500 hover:bg-amber-600 active:scale-[0.99] py-2.5 px-4 rounded-lg transition-all shadow-sm shadow-amber-500/10 focus:outline-none focus:ring-2 focus:ring-amber-500/50"
      >
        Přidat film
      </button>
    </form>
